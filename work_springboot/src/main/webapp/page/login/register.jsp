...
<form class="layui-form" action="registerServlet" method="post">
    ...
    <%--<div class="layui-form-item input-item">--%>
        <%--<label for="password">密码</label>--%>
        <%--<input type="password" name="password2" placeholder="请再次输入密码" autocomplete="off" id="" class="layui-input" lay-verify="required">--%>
    <%--</div>--%>
    ...
    <div class="layui-form-item">
       ...
       <input type="submit" class="layui-btn layui-block"  value="注册" />
    </div>
